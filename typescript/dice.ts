...
function changePlayers():void{
    ...
    if(currentPlayerName == player1Name){
        ...
        document.getElementById("current").innerText = (<HTMLInputElement>document.getElementById("player2")).value;
    }
    else if(currentPlayerName == player2Name){
        //set currentPlayerName to the next player
        document.getElementById("current").innerText = (<HTMLInputElement>document.getElementById("player1")).value;
    }
    else{
        document.getElementById("current").innerText = (<HTMLInputElement>document.getElementById("player1")).value;
    }
...
function rollDie():void{
    ...
    let randomNumber = generateRandomValue(1, 7);
    ...
    if(randomNumber == 1){
        ...
        (<HTMLInputElement>document.getElementById("die")).value = randomNumber.toString();
...
function holdDie():void{
    ...
    else if(currentPlayerName == (<HTMLInputElement>document.getElementById("player2")).value){
        score2 += currTotal;
